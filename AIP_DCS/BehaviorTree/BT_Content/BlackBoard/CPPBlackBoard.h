...
public:
	...
	float MySpecificEnergy;									// specific energy = alt + V^2/2g (m)
	float TargetSpecificEnergy;								// target specific energy (m)

	bool TargetInMyWEZ;										// target inside my WEZ (I can score)
	bool IamInTargetWEZ;									// I am inside target's WEZ (I can be hit)
